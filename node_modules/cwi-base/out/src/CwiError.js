 ...
 * classes.
 */
class CwiError extends Error {
    constructor(code, description, stack, details) {
        super(description);
    ...
    static fromUnknown(err) {
        ...
        const e = new CwiError(code, description, stack, Object.keys(details).length > 0 ? details : undefined);
        if (err !== null && typeof err === 'object') {
...
exports.CwiError = CwiError;
//# sourceMappingURL=CwiError.js.map