...
import { CreateActionOptions, CreateCertificateResult, DojoSendWithResultsApi, EnvelopeApi, EnvelopeEvidenceApi, MapiResponseApi, OptionalEnvelopeEvidenceApi, OutPoint } from '@babbage/sdk-ts';
...
export declare function toDojoSyncError(e: CwiError): DojoSyncErrorApi;
...
export declare const DojoProvenTxReqTerminalStatus: DojoProvenTxReqStatusApi[];
export declare const DojoProvenTxReqNonTerminalStatus: DojoProvenTxReqStatusApi[];
...
//# sourceMappingURL=DojoClientApi.d.ts.map